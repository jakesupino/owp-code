...
% following Caffrey et al. (2014) and Beck et al. (2015), i.e., using the Thebault 
% et al. (2008) implementation of Ro & Hunt (2006).*
%
...
%
% *UPDATE: Based on an evaluation of different k parameterizations (see
% dielAnalysis_compare_k.m), we decided not to use Ro & Hunt (2006).
%
% AUTHOR:
% Emily Chua
%
